    ...
    return (<>
            ...
            {show && <Row gutter={24}>
                <Col span={24}>
                    ...
                    { selectedSeats.length > 0 && <StripeCheckout token={onToken} billingAddress amount={selectedSeats.length * show.ticketPrice * 100} stripeKey="pk_test_51NqI5xSGUfHxcIWSfnC9Dqiku8WFe44dhEA7OQPPzQmZicf0pXfFD6tPjC9o2li7WXbCMEtsq4JQZwFeywpT4QjQ00vCX3AgcP">
